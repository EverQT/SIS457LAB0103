...
ASIS457LAB0103BlockGrid::ASIS457LAB0103BlockGrid()
{
	...
	BiografiaText->SetRelativeLocation(FVector(120.f, 0.f, 0.f));
	BiografiaText->SetRelativeRotation(FRotator(50.f, 0.f, 0.f));
	BiografiaText->SetText(FText::Format(LOCTEXT("ScoreFmt", "Biografia de Quispe Torrez Ever \nCarrera: Ing. de Sistemas \nCU: 35-4504 \nCI: 10463104: {0}"), FText::AsNumber(0)));
...
void ASIS457LAB0103BlockGrid::AddBiografia()
{
	// Increment score
	//Biografia++;

	// Update text
	BiografiaText->SetText(FText::Format(LOCTEXT("ScoreFmt", "Biografia: {0}"), FText::AsNumber(Score)));
}
